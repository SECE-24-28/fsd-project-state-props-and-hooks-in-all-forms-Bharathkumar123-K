              ...
              <div className="overflow-x-auto">
                <table className="w-full text-sm">
                  <thead className="bg-gray-50 border-b border-gray-100">
                    <tr>{['Pet', 'Breed', 'Age', 'Gender', 'Price', 'Status', 'Actions'].map(h => (
                  ...
                  <tbody>
                    {pets.map(pet => (
                      <tr key={pet._id} className="border-b border-gray-50 hover:bg-gray-50">
                        ...
                        <td className="px-4 py-3 text-gray-500 capitalize">{pet.gender}</td>
                        <td className="px-4 py-3 font-semibold text-primary-600">{formatPrice(pet.price)}</td>
      ...
      <Modal isOpen={showModal} onClose={() => setShowModal(false)} title={editId ? 'Edit Pet' : 'Add Pet'} size="lg">
        <form onSubmit={handleSubmit} className="space-y-4">
          <div className="grid grid-cols-2 gap-4">
            ...
            <div><label className="label">Age *</label><input className="input" value={form.age} onChange={set('age')} required /></div>
            <div>
            ...
            <div><label className="label">Weight</label><input className="input" value={form.weight} onChange={set('weight')} /></div>
            <div>
