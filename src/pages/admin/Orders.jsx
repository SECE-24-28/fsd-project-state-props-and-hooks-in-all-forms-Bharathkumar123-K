        ...
        {selectedOrder && (
          <div className="space-y-4">
            ...
            <div className="bg-gray-50 rounded-xl p-3 text-sm">
              <p><strong>Ship to:</strong> {selectedOrder.shippingAddress?.street}, {selectedOrder.shippingAddress?.city}, {selectedOrder.shippingAddress?.state} {selectedOrder.shippingAddress?.zip}</p>
              <p className="mt-1"><strong>Payment:</strong> {selectedOrder.paymentMethod?.toUpperCase()} · <strong>Total:</strong> ${selectedOrder.totalPrice?.toFixed(2)}</p>
            </div>
